...
// FeedbackLoop
#define COCOAPODS_POD_AVAILABLE_FeedbackLoop
#define COCOAPODS_VERSION_MAJOR_FeedbackLoop 0
#define COCOAPODS_VERSION_MINOR_FeedbackLoop 1
#define COCOAPODS_VERSION_PATCH_FeedbackLoop 58
